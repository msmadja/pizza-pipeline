...
const HANDLER_NAME = "oven.handled";
...
async function handler() { 
    try {
        ...
        channel.consume(HANDLER_NAME, async data => {
            ...
            /*
            * Prepare the pizza for the waiter
            */
            await new Promise(r => setTimeout(r, 5000));
            await channel.sendToQueue("waiter.handled", Buffer.from(JSON.stringify(data.content.toString())));
